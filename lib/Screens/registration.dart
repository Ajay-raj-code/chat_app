      ...
      body: Padding(
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              const Text("Let's Create Your Account", style:  TextStyle(fontWeight: FontWeight.bold, fontSize: 30),),
              SizedBox(
                height: height*0.55,
                child: Form(
                    key: _formKey,
              ...
              customButton(title: "Create Account", onTap: () async{
                if(_formKey.currentState!.validate()){
                 if(_passwordController.text.trim() == _confirmPasswordController.text.trim()){
                   ...
                   Get.snackbar("Password", "Password and confirm password does not match");
                 }
                }
              },),
              ...
              Row(
                ...
                children: [
                  ...
                  Text("We'll never share your info",style: TextStyle( color: Colors.grey.shade500),),
                ],
              ),
